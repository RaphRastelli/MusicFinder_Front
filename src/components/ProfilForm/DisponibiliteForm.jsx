...
import { AVAILABILITY_LEVELS } from '../../data/referentiels.js';
import Toast from '../Toast/Toast.jsx';
import style from './ProfilForm.module.css';

export default function DisponibiliteForm({ onSave, initialValues }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selected === null) {
      setToast({ message: 'Vous devez choisir une disponibilité !', type: 'error' });
      return;
    }
    ...
    try {
      ...
      setToast({ message: 'Votre disponibilité est enregistrée', type: 'success' });
    } catch {
